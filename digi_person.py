...
class YourData:
    ...
    def save_user_friendly_csv():
        one_hot_encoded_file = '/Users/miry/Documents/repos/CF-experimentation/data/selected_person.csv'
        user_friendly_file = '/Users/miry/Documents/repos/CF-experimentation/data/user_friendly_personas_with_survival.csv'
        ...
        if os.path.exists(one_hot_encoded_file):
            ...
            # Format `Fare` as currency with 2 decimal places
